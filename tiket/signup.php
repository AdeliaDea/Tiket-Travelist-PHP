        ...
        <center>
            <div style="padding-top: 125px;">
                ...
                <div class="container" style="width: 500px;">
                    ...
                    <p class="left">Sudah punya akun? Silahkan langsung Sign In.</p><a href="signin.php" style="font-family: segoe ui light;"><button class="btn waves-effect">Sign In  <i class="ion-log-in"></i></button></a>
                </div>
            </div>
        </center>
    </div>
