...
<head>
    <title>TraveList | Penyedia Tiket Kendaraan </title>
            ...
            <div class="col s7">
                <div class="card-panel">
                    ...
                    <form method="post" action="pesan_p.php">
                        ...
                        ?>
                            <div class="input-field">
                                <p class="grey-text">Booking Tanggal Berangkat</p>
                          ...
                          <div class="input-field">
                            ...
                            <div class="input-field">
                                <p class="grey-text">Booking Tanggal Kembali</p>
                                <input type="date" name="rest_a">
                            </div>
                            <div class="input-field">
