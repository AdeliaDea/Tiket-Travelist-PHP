...
$sql = mysqli_query($conn, 'insert into customer (id_customer, email, name, address, phone, gender, username) values("'.$id_cus.'", "'.$email.'", "'.$name.'", "'.$address.'", "'.$phone.'", "'.$gender.'", "'.$username.'") ');
if($sql) {
