    ...
    <div class="white-text" style="background-color: rgba(0, 0, 0, 0.75); width: 100%; height:700px; margin-top: -35px;">
        <center>
            <div style="padding-top: 175px;">
                ...
                <p style="font-family: lobster; font-size: 21px;">TraveList <b>Mode Admin</b></p>
                <div class="container" style="width: 500px;">
                    ...
                    <p>Developed by <a href="https://kelompokkamiSI.com/" title="KelompokKamiSI.com" target="_blank">KelompokKamiSI.com</a></p>
                </div>
            </div>
        </center>
    </div>
